    ...
    <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Software engineer focused on mobile development, frontend
              engineering, and scalable application design. Experienced building
              production-ready React Native applications, leading technical
              teams, and delivering software from concept through release.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                href="#contact"
                className="inline-flex items-center rounded-2xl bg-blue-500 px-6 py-4 text-base hover:bg-blue-600"
              >
                <Mail className="mr-2 h-5 w-5" /> Contact Me
              </Button>

              <Button
                href="https://github.com/Muck3k"
                className="inline-flex items-center rounded-2xl border border-zinc-700 bg-zinc-900/60 px-6 py-4 text-base text-white hover:bg-zinc-800"
              >
                GitHub
              </Button>

              <Button
                href="https://www.linkedin.com/in/matthewodonnell3/"
                className="inline-flex items-center rounded-2xl border border-zinc-700 bg-zinc-900/60 px-6 py-4 text-base text-white hover:bg-zinc-800"
              >
                LinkedIn
              </Button>
          ...
          >
            <Card className="rounded-[2rem] border-zinc-800 bg-zinc-900/80 shadow-2xl shadow-blue-950/20 backdrop-blur">
              <CardContent className="p-8">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 to-blue-700">
                ...
                <p className="mt-3 text-zinc-300">
                  Building production-ready mobile applications with clean UI,
                  scalable Firebase architecture, and reliable release workflows.
                </p>
      ...
      <main className="mx-auto max-w-6xl px-6 py-14 sm:px-10 lg:px-20">
          ...
          {[
            {
              ...
              text: "Experience building polished mobile interfaces, navigation flows, authentication, and production app features.",
            },
            {
              icon: Database,
              title: "Backend Integration",
              text: "Hands-on Firebase experience with Firestore data modeling, authentication, storage, and cloud functions.",
            },
            {
              icon: Users,
              title: "Team Collaboration",
              text: "Scrum Master and team leadership experience with planning, communication, and delivery coordination.",
            },
          ].map(({ icon: Icon, title, text }, index) => (
            <FadeIn key={title} delay={index * 0.08}>
              <Card className="h-full rounded-3xl border-zinc-800 bg-zinc-900/70">
        ...
        <section className="mt-20">
          <FadeIn>
            <p className="text-center text-sm font-medium uppercase tracking-[0.3em] text-blue-300">
              Skills
            </p>
        ...
        <FadeIn>
          <section
            id="contact"
            className="mt-20 rounded-[2rem] border border-zinc-800 bg-gradient-to-br from-zinc-900 to-zinc-950 p-8 sm:p-10"
          >
            ...
            <p className="mt-4 max-w-2xl text-zinc-300">
              Interested in mobile development, frontend engineering, and
